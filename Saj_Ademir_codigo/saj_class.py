...
class mainSAJ:  
    ...
    def converteEmExcel(self, new_lista_exc_fisc,new_lista_exc_prev):
        ...
        arquivo_excel_todos_processos_fisc = f'{path_resultados}\\todos_processos_fisc.xlsx'
        arquivo_excel_todos_processos_prev = f'{path_resultados}\\todos_processos_prev.xlsx'
        df1.to_excel(arquivo_excel_todos_processos_fisc)
        df2.to_excel(arquivo_excel_todos_processos_prev)

    def converteEmExcelOutrosProcessos(self, new_lista_outros_processos):
        path_leitura = "Y:\\DIAFI-PRE-TRIAGEM\\Arthur\\Repos_\\Naj_\\Saj_Ademir_codigo\\Excel_leitura"
        path_resultados = "Y:\\DIAFI-PRE-TRIAGEM\\Arthur\\Repos_\\Naj_\\Saj_Ademir_codigo\\Excel_resultados"
        df3 = pandas.DataFrame(new_lista_outros_processos )
        arquivo_excel_outros_processos = f'{path_resultados}\\todos_processos_outros.xlsx'
    ...
    def consultarProcessosSAj(self):
            ...
            new_lista_exc_fisc = [['1','2','3','4',"5","6","7","8"]]
            new_lista_exc_prev = [['1','2','3','4',"5","6"]]
            ...
            for arquivo_excel in ListaProcessos:
                ...
                try:
                    for i, row in dados_temporarios.iterrows():
                        ...
                        try:  
                            self.verifica_info(new_lista_exc_fisc,new_lista_exc_prev,valor)
                    
                        except:
                            print("NÃO É FISCAL NEM PREVIDENCIÁRIA")
